...
<head>
	...
	<link rel="shortcut icon" href="{{asset('fontend_assets/images/favicon.png')}}" type="image/x-icon">
	<link rel="icon" href="{{asset('fontend_assets/images/favicon.png')}}" type="image/x-icon">
  ...
  <meta name="theme-name" content="wallet" />
	...
	<!-- # CSS Plugins -->
	<link rel="stylesheet" href="{{asset('fontend_assets/plugins/slick/slick.css')}}">
	<link rel="stylesheet" href="{{asset('fontend_assets/plugins/font-awesome/fontawesome.min.css')}}">
	<link rel="stylesheet" href="{{asset('fontend_assets/plugins/font-awesome/brands.css')}}">
	<link rel="stylesheet" href="{{asset('fontend_assets/plugins/font-awesome/solid.css')}}">
	...
	<nav class="navbar navbar-expand-xl navbar-light text-center py-3">
		<div class="container">
			<a class="navbar-brand" href="index.html">
				<img loading="prelaod" decoding="async" class="img-fluid" width="160" src="{{asset('fontend_assets/images/logo.png')}}" alt="Wallet">
			</a>
         ...
         @if (Route::has('login'))
          @auth
				<!-- account btn --> <a href="{{ url('/dashboard') }}" class="btn btn-outline-primary">Dashboard</a>
          @else
      ...
      <div class="col-lg-6">
        <div class="ps-lg-5 text-center">
          <img loading="lazy" decoding="async"
            src="{{asset('fontend_assets/images/banner/banner.png')}}"
  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-lg-7 text-center text-lg-end">
        <img loading="lazy" decoding="async" src="{{asset('fontend_assets/images/about-us.png')}}" alt="About Ourselves" class="img-fluid">
      </div>
    </div>
  </div>
  <div class="has-shapes">
        ...
        <div class="rounded shadow bg-white p-5 tab-content" id="pills-tabContent">
            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-6 order-0 order-md-1 mb-5 mt-md-0">
                <div class="image-block text-center">
                  <img loading="lazy" decoding="async"
                    src="{{asset('fontend_assets/images/payment-info.png')}}" alt="How Much Can I Recive?" class="img-fluid">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="tab-pane fade " id="pills-how-do-i-repay" role="tabpanel"
            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-6 order-0 order-md-1 mb-5 mt-md-0">
                <div class="image-block text-center">
                  <img loading="lazy" decoding="async" src="{{asset('fontend_assets/images/illustration-1.png')}}" alt="How Do I Repay?" class="img-fluid">
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="row position-relative">
      ...
      <div class="col-lg-4 col-md-6 pt-1">
        <div class="shadow rounded bg-white p-4 mt-4">
          <div class="d-block d-sm-flex align-items-center mb-3">
            <img loading="lazy" decoding="async"
              src="{{asset('fontend_assets/images/testimonials/02.jpg')}}"
      ...
      <div class="col-lg-4 col-md-6 pt-1">
        <div class="shadow rounded bg-white p-4 mt-4">
          <div class="d-block d-sm-flex align-items-center mb-3">
            <img loading="lazy" decoding="async"
              src="{{asset('fontend_assets/images/testimonials/03.jpg')}}"
      ...
      <div class="col-lg-4 col-md-6 pt-1">
        <div class="shadow rounded bg-white p-4 mt-4">
          <div class="d-block d-sm-flex align-items-center mb-3">
            <img loading="lazy" decoding="async"
              src="{{asset('fontend_assets/images/testimonials/04.jpg')}}"
      ...
      <div class="col-lg-4 col-md-6 pt-1">
        <div class="shadow rounded bg-white p-4 mt-4">
          <div class="d-block d-sm-flex align-items-center mb-3">
            <img loading="lazy" decoding="async"
              src="{{asset('fontend_assets/images/testimonials/05.jpg')}}"
      ...
      <div class="col-lg-4 col-md-6 pt-1">
        <div class="shadow rounded bg-white p-4 mt-4">
          <div class="d-block d-sm-flex align-items-center mb-3">
            <img loading="lazy" decoding="async"
              src="{{asset('fontend_assets/images/testimonials/06.jpg')}}"
...
<!-- # JS Plugins -->
<script src="{{asset('fontend_assets/plugins/jquery/jquery.min.js')}}"></script>
<script src="{{asset('fontend_assets/plugins/bootstrap/bootstrap.min.js')}}"></script>
<script src="{{asset('fontend_assets/plugins/slick/slick.min.js')}}"></script>
<script src="{{asset('fontend_assets/plugins/scrollmenu/scrollmenu.min.js')}}"></script>

<!-- Main Script -->
<script src="{{asset('fontend_assets/js/script.js')}}"></script>
